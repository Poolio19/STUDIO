...
export const teams: Team[] = [
    { id: 'team_1', name: 'Arsenal', logo: 'drill', bgColourFaint: 'rgba(239, 1, 7, 0.2)', bgColourSolid: '#EF0107', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    ...
    { id: 'team_4', name: 'Brentford', logo: 'bug', bgColourFaint: 'rgba(200, 16, 46, 0.2)', bgColourSolid: '#C8102E', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_5', name: 'Brighton', logo: 'bird', bgColourFaint: 'rgba(0, 87, 184, 0.2)', bgColourSolid: '#0057B8', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_6', name: 'Chelsea', logo: 'creativeCommons', bgColourFaint: 'rgba(3, 70, 148, 0.2)', bgColourSolid: '#034694', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_7', name: 'Crystal Palace', logo: 'rabbit', bgColourFaint: 'rgba(27, 69, 143, 0.2)', bgColourSolid: '#1B458F', textColour: '#C4122E', iconColour: '#C4122E' },
    { id: 'team_8', name: 'Everton', logo: 'home', bgColourFaint: 'rgba(0, 51, 153, 0.2)', bgColourSolid: '#003399', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_9', name: 'Fulham', logo: 'shieldHalf', bgColourFaint: 'rgba(255, 255, 255, 0.2)', bgColourSolid: '#FFFFFF', textColour: '#000000', iconColour: '#000000' },
    { id: 'team_10', name: 'Ipswich Town', logo: 'shield', bgColourFaint: 'rgba(0, 87, 184, 0.2)', bgColourSolid: '#0057B8', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_11', name: 'Leicester City', logo: 'shield', bgColourFaint: 'rgba(0, 83, 160, 0.2)', bgColourSolid: '#0053A0', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_12', name: 'Liverpool', logo: 'origami', bgColourFaint: 'rgba(200, 16, 46, 0.2)', bgColourSolid: '#C8102E', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_13', name: 'Man City', logo: 'sailboat', bgColourFaint: 'rgba(108, 171, 221, 0.2)', bgColourSolid: '#6CABDD', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_14', name: 'Man Utd', logo: 'hamburger', bgColourFaint: 'rgba(218, 41, 28, 0.2)', bgColourSolid: '#DA291C', textColour: '#FBE122', iconColour: '#FBE122' },
    { id: 'team_15', name: 'Newcastle', logo: 'castle', bgColourFaint: 'rgba(36, 31, 32, 0.2)', bgColourSolid: '#241F20', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_16', name: 'Notts Forest', logo: 'treeDeciduous', bgColourFaint: 'rgba(221, 0, 0, 0.2)', bgColourSolid: '#DD0000', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_17', name: 'Southampton', logo: 'flower', bgColourFaint: 'rgba(215, 25, 32, 0.2)', bgColourSolid: '#D71920', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_18', name: 'Tottenham', logo: 'origami', bgColourFaint: 'rgba(19, 34, 87, 0.2)', bgColourSolid: '#132257', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_19', name: 'West Ham', logo: 'utensilsCrossed', bgColourFaint: 'rgba(122, 38, 58, 0.2)', bgColourSolid: '#7A263A', textColour: '#FBB117', iconColour: '#FBB117' },
    { id: 'team_20', name: 'Wolves', logo: 'gitlab', bgColourFaint: 'rgba(253, 185, 19, 0.2)', bgColourSolid: '#FDB913', textColour: '#231F20', iconColour: '#231F20' },
    { id: 'team_21', name: 'Burnley', logo: 'shield', bgColourFaint: 'rgba(108, 29, 69, 0.2)', bgColourSolid: '#6C1D45', textColour: '#99D6EA', iconColour: '#99D6EA'},
    { id: 'team_22', name: 'Leeds', logo: 'mapPin', bgColourFaint: 'rgba(255, 205, 0, 0.2)', bgColourSolid: '#FFCD00', textColour: '#1D428A', iconColour: '#1D428A' },
    { id: 'team_23', name: 'Sunderland', logo: 'theater', bgColourFaint: 'rgba(235, 23, 43, 0.2)', bgColourSolid: '#EB172B', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
];
