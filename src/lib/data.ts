...
export const monthlyMimoM: MonthlyMimoM[] = [
    ...
    { month: 'September', year: 2025, userId: 'usr_26', type: 'winner' },
    { month: 'September', year: 2025, userId: 'usr_22', type: 'runner-up' },
    { month: 'September', year: 2025, userId: 'usr_7', type: 'runner-up' },
];
