...
export const teams: Team[] = [
    ...
    { id: 'team_5', name: 'Brighton', logo: 'bird', bgColourFaint: 'rgba(0, 87, 184, 0.2)', bgColourSolid: '#0057B8', textColour: '#000000', iconColour: '#FFFFFF' },
    ...
    { id: 'team_7', name: 'Crystal Palace', logo: 'rabbit', bgColourFaint: 'rgba(27, 69, 143, 0.2)', bgColourSolid: '#1B458F', textColour: '#FFFFFF', iconColour: '#C4122E' },
    ...
    { id: 'team_9', name: 'Fulham', logo: 'shieldHalf', bgColourFaint: 'rgba(0, 0, 0, 0.2)', bgColourSolid: '#000000', textColour: '#FFFFFF', iconColour: '#FFFFFF' },
    { id: 'team_10', name: 'Ipswich Town', logo: 'shield', bgColourFaint: 'rgba(0, 87, 184, 0.2)', bgColourSolid: '#0057B8', textColour: '#000000', iconColour: '#FFFFFF' },
    { id: 'team_11', name: 'Leicester City', logo: 'shield', bgColourFaint: 'rgba(0, 83, 160, 0.2)', bgColourSolid: '#0053A0', textColour: '#000000', iconColour: '#FFFFFF' },
    { id: 'team_12', name: 'Liverpool', logo: 'origami', bgColourFaint: 'rgba(200, 16, 46, 0.2)', bgColourSolid: '#C8102E', textColour: '#000000', iconColour: '#FFFFFF' },
    { id: 'team_13', name: 'Man City', logo: 'sailboat', bgColourFaint: 'rgba(108, 171, 221, 0.2)', bgColourSolid: '#6CABDD', textColour: '#000000', iconColour: '#FFFFFF' },
    { id: 'team_14', name: 'Man Utd', logo: 'hamburger', bgColourFaint: 'rgba(218, 41, 28, 0.2)', bgColourSolid: '#DA291C', textColour: '#000000', iconColour: '#FBE122' },
    ...
    { id: 'team_16', name: 'Notts Forest', logo: 'treeDeciduous', bgColourFaint: 'rgba(221, 0, 0, 0.2)', bgColourSolid: '#DD0000', textColour: '#000000', iconColour: '#FFFFFF' },
    { id: 'team_17', name: 'Southampton', logo: 'flower', bgColourFaint: 'rgba(215, 25, 32, 0.2)', bgColourSolid: '#D71920', textColour: '#000000', iconColour: '#FFFFFF' },
    ...
    { id: 'team_19', name: 'West Ham', logo: 'utensilsCrossed', bgColourFaint: 'rgba(122, 38, 58, 0.2)', bgColourSolid: '#7A263A', textColour: '#FFFFFF', iconColour: '#FBB117' },
    ...
    { id: 'team_21', name: 'Burnley', logo: 'shield', bgColourFaint: 'rgba(108, 29, 69, 0.2)', bgColourSolid: '#6C1D45', textColour: '#FFFFFF', iconColour: '#99D6EA'},
    ...
    { id: 'team_23', name: 'Sunderland', logo: 'theater', bgColourFaint: 'rgba(235, 23, 43, 0.2)', bgColourSolid: '#EB172B', textColour: '#000000', iconColour: '#FFFFFF' },
];
