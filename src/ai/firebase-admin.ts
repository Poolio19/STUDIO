...
const TARGET_PROJECT_ID = 'predictatron-app-2';
...
function initializeAdminApp(databaseId?: string): admin.app.App {
  ...
  try {
    ...
    const app = admin.initializeApp({
      ...
      databaseURL: databaseId ? `https://predictatron-app-2.firebaseio.com?database=${databaseId}` : `https://predictatron-app-2.firebaseio.com`
    }, appName);
