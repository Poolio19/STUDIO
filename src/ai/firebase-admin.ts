...
const TARGET_PROJECT_ID = 'prempred-43933-2';
...
function initializeAdminApp(databaseId?: string): admin.app.App {
  ...
  try {
    ...
    const app = admin.initializeApp({
      ...
      databaseURL: databaseId ? `https://prempred-43933-2.firebaseio.com?database=${databaseId}` : `https://prempred-43933-2.firebaseio.com`
    }, appName);
