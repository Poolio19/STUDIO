                        ...
                        <TableHeader>
                            <TableRow className="h-[102px]">
                                ...
                                <TableHead className="text-center p-0 w-[40px] border-l border-dashed border-border">
                                    <div className="[writing-mode:vertical-rl] transform-gpu rotate-180 whitespace-nowrap font-bold h-[92px] w-full flex items-end justify-start">TOTAL</div>
                                </TableHead>
                                {sortedTeams.map((team) => {
                                    return (
                                    <TableHead key={team.id} className="text-left p-0 w-[40px] border-l border-dashed border-border">
                                        <div className="[writing-mode:vertical-rl] transform-gpu rotate-180 whitespace-nowrap font-medium h-[92px] w-full flex items-end justify-start">{team.name}</div>
                                    </TableHead>
                                )})}
                            </TableRow>
                        </TableHeader>
