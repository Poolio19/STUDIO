                    ...
                    <Table className="min-w-full border-collapse">
                        <TableHeader>
                            <TableRow className="h-[102px]">
                                ...
                                <TableHead className="text-center p-0 border-l border-dashed border-border">
                                     <div
                                ...
                                {sortedTeams.map((team) => {
                                    return (
                                    <TableHead key={team.id} className="text-left p-0 border-l border-dashed border-border">
                                        <div
