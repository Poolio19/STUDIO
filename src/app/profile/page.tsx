                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1 w-12">
                                            ...
                                            <Medal className={cn("size-7", Number(user?.second) > 0 ? "text-slate-400" : "text-gray-300 dark:text-gray-600")} />
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1 w-12">
                                            ...
                                            <Trophy className={cn("size-8", Number(user?.first) > 0 ? "text-yellow-500" : "text-gray-300 dark:text-gray-600")} />
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1 w-12">
                                            ...
                                            <Medal className={cn("size-6", Number(user?.third) > 0 ? "text-amber-700" : "text-gray-300 dark:text-gray-600")} />
                        ...
                        <div className="flex justify-around">
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1">
                                            <Award className={cn("size-7", Number(user?.mimoM) > 0 ? "text-yellow-600" : "text-gray-300 dark:text-gray-600")} />
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1">
                                            <Award className={cn("size-6", Number(user?.joMimoM) > 0 ? "text-yellow-600/80" : "text-gray-300 dark:text-gray-600")} />
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1">
                                            <Award className={cn("size-7", Number(user?.ruMimoM) > 0 ? "text-slate-400" : "text-gray-300 dark:text-gray-600")} />
                                 ...
                                 <Tooltip>
                                    <TooltipTrigger>
                                        <div className="flex flex-col items-center gap-1">
                                            <Award className={cn("size-6", Number(user?.joRuMimoM) > 0 ? "text-slate-400/80" : "text-gray-300 dark:text-gray-600")} />
